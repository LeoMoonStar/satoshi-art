const text: { [key: string]: string } = {
  ...
  youAreAboutToPurchase: 'You are about to purchase <1>{{name}}</1>  by <1>{{author}}</1>',
  ...
  termsOfServiceDomain: '{{domain}} Terms of Service',
  termsOfServiceDomainInfo:
    'Please take a few minutes to read and understand <1>{{domain}}</1> Terms of Service. To continue, you’ll need to accept the Terms of Service by checking the box.',
  atLeast13YearOld: 'I am at least 13 years old',
  acceptTermsOfService: 'I accept the {{domain}} terms of service',
  ...
  'privacy-domainPrivacy': '{{domain}} Privacy',
