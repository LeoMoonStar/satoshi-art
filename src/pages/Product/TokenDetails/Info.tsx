...
export const Info = ({ collectible }: { collectible: CollectibleInfo }): JSX.Element => {
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.collectionContainer}>
        <Avatar size={48} alt='Profile photo' image='https://images.rarible.com/?fit=outsize&n=-1&url=https%3A%2F%2Fipfs.rarible.com%2Fipfs%2FQmUYRjX7CNrUzPXJ287v5YZGDSKxztc6ddBkiWvG8BBsDe&w=240'/>
        <div className={classes.artistInfo}>
          <Typography variant='subtitle1' className={classes.artistRole}>Collection(ERC721)</Typography>
