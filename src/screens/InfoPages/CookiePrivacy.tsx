        ...
        <Layout>
            <div className={classes.container}>
                ...
                <div className={classes.contentContainer}>
                    ...
                    <div>
                        <p>
                            This cookies policy (the “<b>Cookies Policy</b>”)
                            explains what Cookies are and how We use them. You
                            should read this Cookies Policy so You can
                        ...
                        <p>
                            ...
                            For further information on how We use, store and
                            keep your personal data secure, see Our Privacy
                            Policy. We do not store sensitive personal
                            information, such as mailing addresses, account
                        ...
                        <p>
                            <span>
                                ...
                                this Cookies Policy) means Satoshi.ART Inc.
                            </span>
                            <span>
                                “<strong>Cookies</strong>” means small files
                                that are placed on Your computer, mobile device
                                or any other device by a website, containing
                                details of your browsing history on that website
                                among its many uses.
                            </span>
                            <span>
                                “<strong>Website</strong>” means the Satoshi.ART
                                Inc. website..
                            </span>
                            <span>
                                “<strong>You</strong>” means the individual
                                accessing or using the Website, or a company, or
                                any legal entity on behalf of which such
                        ...
                        <p>
                            ...
                            <span>
                                ...
                                habits to enable Us to show advertising which is
                                more likely to be of interest to You. These
                                Cookies use information about your browsing
                                history to group You with other users who have
                                similar interests. Based on that information,
                                and with Our permission, third party advertisers
                                can place Cookies to enable them to show adverts
                                which We think will be relevant to your
                        ...
                        <p>
                            ...
                            Website, first You must disable the use of Cookies
                            in your browser and then delete the Cookies saved in
                            your browser associated with the Website. You may
                            use this option for preventing the use of Cookies at
                            any time. If You do not accept Our Cookies, You may
                            experience some inconvenience in your use of the
                        ...
                        <p>
                            ...
                            Cookies Policy, you email us at{' '}
                            <a
                                rel="noreferrer"
                                target="_blank"
                                href="mailto:support@satoshi.art"
                            >
                                support@satoshi.art
                            </a>
                        </p>
